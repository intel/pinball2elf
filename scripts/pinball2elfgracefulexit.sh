...
if  [ $# -eq 2 ];  then
        echo "asm" >>  /tmp/graceful_exit_callbacks.$$.c
        echo "(" >>  /tmp/graceful_exit_callbacks.$$.c
        #echo "\".section .text \\n\"" >>  /tmp/graceful_exit_callbacks.$$.c
        #echo "\".section .pbtext \\n\"" >>  /tmp/graceful_exit_callbacks.$$.c
        echo "\".globl dummy_function \\n\"" >>  /tmp/graceful_exit_callbacks.$$.c
        echo "\".set dummy_function, $2 \\n\"" >>  /tmp/graceful_exit_callbacks.$$.c
        echo "\".type dummy_function,function\\n\"" >>  /tmp/graceful_exit_callbacks.$$.c
        echo ");" >>  /tmp/graceful_exit_callbacks.$$.c
fi
